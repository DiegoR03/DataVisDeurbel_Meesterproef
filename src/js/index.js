...
async function init() {
  ...
  if (data && data.length > 0) {
    ...
    const fishSpecies = [
      {
        name: "Ruisvoorn",
        legendId: "legend-ruisvoorn",
        imgPath: "./public/img/ruisvoorn.png",
      },
      {
        name: "Baars",
        legendId: "legend-baars",
        imgPath: "./public/img/baars.png",
      },
      {
        name: "Paling",
        legendId: "legend-paling",
        imgPath: "./public/img/paling.png",
      },
      {
        name: "Alver",
        legendId: "legend-alver",
        imgPath: "./public/img/alver.png",
      },
      {
        name: "Blankvoorn",
        legendId: "legend-blankvoorn",
        imgPath: "./public/img/blankvoorn.png",
      },
      {
        name: "Brasem",
        legendId: "legend-brasem",
        imgPath: "./public/img/brasem.png",
      },
      {
        name: "Kolblei",
        legendId: "legend-kolblei",
        imgPath: "./public/img/kolblei.png",
      },
      {
        name: "Meerval",
        legendId: "legend-meerval",
        imgPath: "./public/img/meerval.png",
      },
      {
        name: "Snoek",
        legendId: "legend-snoek",
        imgPath: "./public/img/snoek.png",
      },
      {
        name: "Snoekbaars",
        legendId: "legend-snoekbaars",
        imgPath: "./public/img/snoekbaars.png",
      },
      {
        name: "Winde",
        legendId: "legend-winde",
        imgPath: "./public/img/winde.png",
      },
    ];
